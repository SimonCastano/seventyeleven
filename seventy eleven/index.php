...
<section class="contenido index hoverable green-text"><h2 style="font-family: robot;">Los mejores en calidad y precios</h2></section>
<div class="parallax-container " id="inicio">
  <div class="parallax"><video class="video" src="videos/scan.mp4" autoplay="" loop="" muted=""></video></div>
  <main class="index  black-text" style="font-family: robot ;"> <h2>Seventy Eleven Technology</h2> <br> <p>Una empresa dedicada con los mas altos estandares posibles en tecnologia electronica e informatica</p> </main>
</div>
<div>
...
<div class="social">
  <ul>
    ...
    <li><a href="http://www.pinterest.com" target="_blank" class="icon-instagram"></a></li>
    <li><a href="mailto:contacto@falconmasters.com" class="icon-google-hangouts"></a></li>
  </ul>
</div>
<body>
  <div class="container" style="font-family: robot;">
    <div class="section contenido white">
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-">
            <h2 class="center #2e7d32 green darken-3-text"><i class="material-icons">settings_input_component</i></h2>
            <h5 class="center black-text">Soporte Técnico Especializado</h5>
            <p class="light">Para torres...............etc .</p>
          </div>
        </div>
        <div class="col s12 m4">
          <div class="icon-">
            <h2 class="center green-text"><i class="material-icons">settings</i></h2>
            <h5 class="center black-text">Mantenimiento preventivo programado </h5>
            <p class="light">para ordenadores portátiles y de escritorio...........................etc</p>
          </div>
        </div>
        <div class="col s12 m4">
          <div class="icon-">
            <h2 class="center #2e7d32 green darken-3-text"><i class="material-icons">speaker_notes</i></h2>
            <h5   class="center black-text">Actualización de su infraestructura tecnológica</h5>
            <p class="light">Acatualizamos partes de ordenadores (harware) y aplicaciones web ya se frontend o backend (software) y actualización de sistemas operativos vendemos licencias etc</p>
          </div>
        </div>
      </div>
    </div>
